...
class MftHeader:
	...
	def __str__(self):
		retStr=('MFT entry: ' + str(self.recordNumber()) + 
			'/' + str(self.sequenceNumber()) +
			'\n\tSize: ' + str(self.logicalRecordSize()) + 
			'/' + str(self.physicalRecordSize()) +
			'\n\tBase Record: ' + str(self.baseFileMft()) + 
			'/' + str(self.baseFileSequenceNumber()) )
		return retStr
